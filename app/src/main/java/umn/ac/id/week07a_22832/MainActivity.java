package umn.ac.id.week07a_22832;
...
public class MainActivity extends AppCompatActivity {
    private static final int REQUEST_VIDEO_CAPTURE = ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button foto = findViewById(R.id.button);
        Button video = findViewById(R.id.button2);
        ImageView kotakFoto = findViewById(R.id.imageView);
        VideoView kotakVideo = findViewById(R.id.videoView);
